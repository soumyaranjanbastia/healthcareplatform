...
export const getDeviceInfo = () => {
  ...
  return {
    ...
    osVersion: ua.split(')')[0].split('(')[1] || "Unknown", // Attempt to extract OS detail
    ...
    apiLevel: 0,
    deviceVersion: "1.0.0",
    bundleId: "com.swastyam.admin.web",
    isEmulator: false,
    screenResolution: `${window.screen.width}x${window.screen.height}`,
    screenDensity: window.devicePixelRatio || 1.0,
    carrier: "Network",
    localIpAddress: "127.0.0.1", // Cannot reliably get from browser without WebRTC
